...
#################### RUN THE MODEL #######################
def run_model(prefix_what, n_next_words, max_sequence_len, tokenizer):
    ...
    f = open("out/dad_jokes_RNN_what.txt", "w")
...
def main():
    ...
    run_model(args.prefix_what, args.n_next_words, max_sequence_len, tokenizer)
