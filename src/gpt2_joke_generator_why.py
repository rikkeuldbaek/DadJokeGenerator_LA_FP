...
def input_parse():
    ...
    parser.add_argument("--prefix_why", type=str, default= "Why did the", help= "Specify input prompt for model.") 
...
def joke_generator(gpt2, sess, prefix_why, gen_text_len, temperature):

    #predefined variables 
    generated_file = 'out/dad_jokes_gpt2_why.txt1'
    ...
    gpt2.generate_to_file(sess, run_name = 'dadjokes_gpt2_prefix_why',
                        ...
                        prefix=prefix_why, # indicator of starting text for GPT-2
...
def main():
    ...
    joke_generator(gpt2, sess, args.prefix_why, args.gen_text_len, args.temperature)
